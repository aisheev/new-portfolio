    ...
    return (
        ...
        className='relative w-full md:h-screen text-white h-unset'>
            ...
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg'>
                    ...
                    <p className="mb-4 py-6">Hey! I am based in Munich, Germany and am a Software Engineering professional with around 4 years of experience across enterprise IT and frontend development. However, I felt that I had the potential for more, so my curiosity and love for problem-solving led me to dive deeper into the world of software.
                    </p>

                    <p>Thanks to my technical background, my experience leading automation projects and my interest in design, I realized that I have a strong talent for building user-focused web interfaces. I am fascinated by this great world of technologies and possibilities, and I am sure that I will be able to create impactful products both professionally and personally with you.</p>
